...
for (let i = 1; i <= hourDigits; i++) {
    ...
    wrapChildElem = wrap.appendChild(wrapChildElem); //div для номеров часов делаем дочерным элементом wrap
...
// вставляем созданные элементы (часы и стрелки) в конец дочерных элементов wrap
...
wrapChildElemForDigitalWatch.style.top = wrapCenterY - radiusForDigitalWatch+115 + "px";
